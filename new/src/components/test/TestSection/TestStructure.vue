...
<script>
import LearningTargets from '@/components/test/TestSection/LearningTargets.vue';
import QuestionsEditor from '@/components/test/TestSection/QuestionsEditor.vue';
import GenerateQuestion from '@/components/test/TestSection/GenerateQuestion.vue';
import DownloadTest from '@/components/test/TestSection/DownloadTest.vue';
